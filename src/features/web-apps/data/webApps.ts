...
id: "lowfator",
title: "LowFator",
description: "Aplicación web para procesado de audio.",
longDescription: "Especial para procesamiento de audio creativo. Permite experimentar con texturas y efectos para modular el archivo de audio subido por el usuario.",
